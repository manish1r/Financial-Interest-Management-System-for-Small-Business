...
export default function Saved(){
    ...
    async function getRecords(type){
        ...
        const response=await fetch(`https://financial-interest-management-syste-ten.vercel.app/save_${type.toLowerCase()}/${localStorage.getItem('user_id')}`);
    ...
    async function remove(sid) {
        const response=await fetch(`https://financial-interest-management-syste-ten.vercel.app/remove_${type.toLowerCase()}/${sid}`,{method:"DELETE"});
